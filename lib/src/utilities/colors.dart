...
class CustomColors {
  static const Color color1 = Color.fromARGB(255, 19, 18, 19);
  static const Color color2 = Color.fromARGB(149, 172, 64, 166);
  ...
  static final Color googleBackground = Color.fromARGB(255, 247, 247, 248);
}
